            ...
            <li>
                <a href="<?php echo e(route($menu->route_name)); ?>"
                    ...
                    <?php if($menu->route_name === 'staff.validasi' && $pendingNotificationCount > 0): ?>
                        <span
                            style="margin-left: auto; background: #dc3545; color: #fff; font-size: 0.75rem; min-width: 22px; height: 22px; display: inline-flex; align-items: center; justify-content: center; border-radius: 999px; padding: 0 6px; position: absolute; right: 10px; top: 50%; transform: translateY(-50%);"><?php echo e($pendingNotificationCount); ?></span>
                    <?php endif; ?>
                </a>
            </li>
...
<?php /**PATH C:\xampp\htdocs\SipetangApp\web-laravel\resources\views/components/sidebar-menu.blade.php ENDPATH**/ ?>