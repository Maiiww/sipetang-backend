        ...
        <div class="dashboard-container">
            <div>
                <div class="stats-grid">
                    <div class="stat-card-large">
                        ...
                        <div class="number"><?php echo e($statistik['totalUser']); ?></div>
                    </div>
                    <div class="stat-card-dark">
                        <h4>DATA PRODUKSI (BULAN)</h4>
                        <div class="number"><?php echo e($statistik['produksiBulan']); ?> <span
                ...
                <div class="stats-grid">
                    <div class="small-stat">
                        ...
                        <div class="value"><?php echo e($statistik['totalLaporan']); ?></div>
                    </div>
                    <div class="small-stat">
                        <label>Validasi Tertunda</label>
                        <div class="value"><?php echo e($statistik['validasiTertunda']); ?></div>
                    </div>
                </div>
                ...
                <div class="anomaly-alert">
                    ...
                    <div style="margin-top: 10px;">
                        <div style="display: flex; justify-content: space-between; margin-bottom: 10px;">
                            ...
                            <span
                                style="font-size: 12px; font-weight: 700; color: #0d2640;"><?php echo e($statistik['persentaseValidasi']); ?>%</span>
                        </div>
                        <div class="progress-bar">
                            <div class="progress-fill" style="width: <?php echo e($statistik['persentaseValidasi']); ?>%;"></div>
                        </div>
                    </div>
                    <div style="margin-top: 15px; padding-top: 15px; border-top: 1px solid #f0f0f0;">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <span
                                style="font-size: 18px; font-weight: 700; color: #ef4444;"><?php echo e(str_pad($statistik['anomaliDetected'], 2, '0', STR_PAD_LEFT)); ?></span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="sidebar-right">
                <div class="sidebar-right-header">
                    ...
                    <a href="<?php echo e(route('staff.validasi')); ?>">Lihat Semua</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="profileModal" class="profile-modal">
        <div class="profile-modal-content">
            <div class="profile-modal-header">
                ...
                <div class="profile-avatar"><?php echo e(strtoupper(substr($user->nama ?? $user->username, 0, 2))); ?></div>
                <div class="profile-name"><?php echo e($user->nama ?? $user->username); ?></div>
            ...
            <div class="profile-modal-body">
                <div class="profile-item">
                    ...
                    <div class="profile-item-content">
                        ...
                        <div class="profile-item-value"><?php echo e($user->wilayah ?? '-'); ?></div>
                    </div>
                </div>
                ...
                <div class="profile-item">
                    ...
                    <div class="profile-item-content">
                        ...
                        <div class="profile-item-value"><?php echo e($user->jenis_kelamin ?? '-'); ?></div>
                    </div>
                </div>
                ...
                <div class="profile-item">
                    ...
                    <div class="profile-item-content">
                        ...
                        <div class="profile-item-value"><?php echo e($user->no_telepon ?? '-'); ?></div>
                    </div>
                </div>
                ...
                <div class="profile-item">
                    ...
                    <div class="profile-item-content">
                        ...
                        <div class="profile-item-value"><?php echo e($user->alamat ?? '-'); ?></div>
                    </div>
                </div>
...
<?php /**PATH C:\laragon\www\SipetangApp\web-laravel\resources\views/Staff/dashboard.blade.php ENDPATH**/ ?>