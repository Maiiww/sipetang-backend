...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dashboard'); ?> - Sipetang</title>
        ...
        <aside
            ...
            <div class="sidenav-header">
                <a class="navbar-brand m-0" href="#">
                    <div class="navbar-brand-box"
                        ...
                        <img src="<?php echo e(asset('images/sipetang-logo.svg')); ?>" alt="SIPETANG"
            ...
            <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="<?php echo e(request()->routeIs('dashboard') ? 'nav-link active' : 'nav-link'); ?>"
                    ...
                    <li class="nav-item">
                        <a href="#" class="nav-link <?php echo e(request()->is('laporan*') ? 'active' : ''); ?>"
                            id="laporanToggle" aria-expanded="<?php echo e(request()->is('laporan*') ? 'true' : 'false'); ?>">
                        ...
                        <ul class="navbar-nav mt-1 submenu <?php echo e(request()->is('laporan*') ? 'd-block' : 'd-none'); ?>"
                            id="laporanSubmenu">
                            <li class="nav-item">
                                <a href="<?php echo e(url('/laporan/mingguan')); ?>"
                                    class="nav-link text-white <?php echo e(request()->is('laporan/mingguan') ? 'active' : ''); ?>">
                                    <span class="nav-link-text">Laporan Mingguan</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(url('/laporan/bulanan')); ?>"
                                    class="nav-link text-white <?php echo e(request()->is('laporan/bulanan') ? 'active' : ''); ?>">
                                    <span class="nav-link-text">Laporan Bulanan</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(url('/laporan/tahunan')); ?>"
                                    class="nav-link text-white <?php echo e(request()->is('laporan/tahunan') ? 'active' : ''); ?>">
                    ...
                    <li class="nav-item">
                        <a class="<?php echo e(request()->routeIs('laporan.cetak') ? 'nav-link active' : 'nav-link'); ?>"
                            href="<?php echo e(url('/cetak-laporan')); ?>">
                    ...
                    <?php if(auth()->check() && strtolower(auth()->user()->role) === 'admin'): ?>
                        <li class="nav-item">
                            <a class="<?php echo e(request()->routeIs('admin.manajemen.user') ? 'nav-link active' : 'nav-link'); ?>"
                                href="<?php echo e(route('admin.manajemen.user')); ?>">
                                <i class="ni ni-single-02 text-white"></i>
                                <span class="nav-link-text ms-1 text-white">Manajemen User</span>
                            </a>
                        </li>
                    <?php elseif(auth()->check() && strtolower(auth()->user()->role) === 'staff'): ?>
                        <li class="nav-item">
                            <a class="<?php echo e(request()->routeIs('dashboard') || request()->routeIs('staff.dashboard') ? 'nav-link active' : 'nav-link'); ?>"
                        ...
                        <li class="nav-item">
                            <a class="<?php echo e(request()->routeIs('staff.validasi') ? 'nav-link active' : 'nav-link'); ?>"
                                href="<?php echo e(route('staff.validasi')); ?>">
                                <i class="ni ni-check-bold text-white"></i>
                                <span class="nav-link-text ms-1 text-white">Validasi Laporan</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="<?php echo e(request()->routeIs('staff.cetak') ? 'nav-link active' : 'nav-link'); ?>"
                                href="<?php echo e(route('staff.cetak')); ?>">
                                <i class="ni ni-bold-down text-white"></i>
                                <span class="nav-link-text ms-1 text-white">Cetak Laporan</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="<?php echo e(request()->routeIs('staff.statistik') ? 'nav-link active' : 'nav-link'); ?>"
                                href="<?php echo e(route('staff.statistik')); ?>">
                                <i class="ni ni-chart-bar-32 text-white"></i>
                                <span class="nav-link-text ms-1 text-white">Data Statistik</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="<?php echo e(request()->routeIs('staff.notifikasi') ? 'nav-link active' : 'nav-link'); ?>"
                                href="<?php echo e(route('staff.notifikasi')); ?>">
                    ...
                    <?php else: ?>
                        <li class="nav-item">
                            <a class="<?php echo e(request()->routeIs('profile') ? 'nav-link active' : 'nav-link'); ?>"
        ...
        <?php if (! ($hideNav)): ?>
            <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
                ...
                <div class="container-fluid py-1 px-3">
                    ...
                    <h6 class="font-weight-bolder mb-0"><?php echo $__env->yieldContent('page-title', 'Dashboard'); ?></h6>
...
<?php /**PATH C:\laragon\www\SipetangApp\web-laravel\resources\views/layouts/argon.blade.php ENDPATH**/ ?>